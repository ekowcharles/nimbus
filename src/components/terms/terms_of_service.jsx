  ...
  return (
    <div className="area-wordy">
      ...
      <div className="scrollable">
        <h4>OVERVIEW</h4>
        <p>
          This website is operated by Ovsprint LLC. Throughout the site,
          the terms “we”, “us” and “our” refer to Ovsprint LLC. Ovsprint
        ...
        <h4>SECTION 5 - PRODUCTS </h4>
        <p>
          All our products are available exclusively online through the website
          (https://www.ovsprint.com). Some products may have limited quantities
        ...
        <p>
          ...
          product made on this site is void where prohibited
        </p>
        <p>
        ...
        <p>
          ...
          use of goods, content, or any other transactions made in connection
        ...
        <p>
          In no case shall Ovsprint, our directors, officers, employees,
        ...
        <p>
          You agree to indemnify, defend and hold harmless Ovsprint and our
